...
struct ext4_sb_info {
	...
	/* Samsung SEC partition / defrag statistics */
...
/* Samsung ext4 diagnostics retained for the A50 vendor filesystem stack. */
extern void print_iloc_info(struct super_block *sb, struct ext4_iloc iloc);
extern void print_bh(struct super_block *sb, struct buffer_head *bh,
		     int start, int len);
